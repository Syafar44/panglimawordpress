...
if (!function_exists('justg_before_sitemain')) {
    ...
    {
        echo '<div class="content-area col order-2" id="primary">';
    }
}

if (!function_exists('justg_after_sitemain')) {
    /**
     * After Main
     * 
     */
    function justg_after_sitemain()
    {
        echo '</div> <!-- #primary -->';
    }
}
...
if (!function_exists('justg_left_sidebar_check')) {
    ...
    function justg_left_sidebar_check()
    {
        ...
        ?>
            <div class="widget-area left-sidebar pe-md-3 ps-md-0 col-sm-12 order-md-1 order-3" id="left-sidebar" role="complementary">
...
if (!function_exists('justg_right_sidebar_check')) {
    ...
    function justg_right_sidebar_check()
    {
        ...
        ?>
            <div class="widget-area right-sidebar ps-md-3 pe-md-0 col-sm-4 order-3" id="right-sidebar" role="complementary">
                <?php do_action('justg_before_main_sidebar'); ?>
                <?php dynamic_sidebar('main-sidebar'); ?>
                <?php do_action('justg_after_main_sidebar'); ?>
            </div>
...
<?php
 ...
 /**
 * show Velocity captcha
 */
function velocity_captcha() {
