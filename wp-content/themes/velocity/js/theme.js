/*!
  * justg v2.4.4 (https://github.com/VelocityDeveloper/velocity#readme)
...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.justg = {}));
  ...
  */
  ...
  (function ($) {
    // disable menu dropdown toggling on pc
    $('menu-item .dropdown-toggle').data('toggle', '');
    $(window).scroll(function () {
      if ($(this).scrollTop() > 100) {
        $('.scroll-to-top').fadeIn(200);
        if ($(".scroll-to-top")[0]) {
          if ($(".whatsapp-floating.right.scroll-right")[0]) {
            $('.whatsapp-floating').addClass('pull-left');
          }
          if ($(".whatsapp-floating.left.scroll-left")[0]) {
            $('.whatsapp-floating').addClass('pull-right');
          }
        }
      } else {
        $('.scroll-to-top').fadeOut(200);
        $('.whatsapp-floating').removeClass('pull-left').removeClass('pull-right');
      }
    });
    ...
    //Link Menu Bootsrap 5 Clickable
    $(document).ready(function () {
      $('.menu-item a.nav-link.dropdown-toggle > span').click(function () {
